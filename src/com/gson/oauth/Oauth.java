...
public class Oauth {
	...
	private static final String GET_USERINFO_URI = "https://api.weixin.qq.com/sns/userinfo";
	...
	public String getUserInfo(String openid, String at) throws Exception {
		Map<String, String> params = new HashMap<String, String>();
		params.put("access_token", at);
		params.put("openid", openid);
		params.put("lang", "zh_CN");
		return HttpKit.get(GET_USERINFO_URI, params);
	}
