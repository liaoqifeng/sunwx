...
public class WxApiCtrl {
	...
	public @ResponseBody String doPost(HttpServletRequest request,@PathVariable String account,HttpServletResponse response) {
		...
		try {
			...
			return myService.processMsg(msgRequest);
		} catch (Exception e) {
			e.printStackTrace();
			return "error";
		}
	...
	public ModelAndView oauthsns(HttpServletRequest request){
		...
		if(obj != null){
			...
			String state = "";
			String openidUrl = WxApi.getOAuthCodeUrl("Appid", url + "/wxapi/oauthOpenid.html", OAuthScope.Base.toString(), state);
			mv.addObject("openidUrl", openidUrl);
			
			String userinfoUrl = WxApi.getOAuthCodeUrl("Appid", url + "/wxapi/oauthUserinfo.html", OAuthScope.Userinfo.toString(), state);
	...
	public ModelAndView oauthOpenid(String code,String state){
		...
		if(actTmp != null){
			...
			Token token = WxApi.getOAuthToken("Appid", "Appsecret", code);
			//业务处理
	...
	public ModelAndView oauthUserinfo(String code,String state){
		...
		if(actTmp != null){
			...
			JSONObject userinfo = WxApi.getOAuthUserinfo("Appid", "Appsecret", code);
			//业务处理
