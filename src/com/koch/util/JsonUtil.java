...
public class JsonUtil {
	...
	public static String toJsonIgnoreProperties(Object beans, String[] properties) throws RuntimeException {
		...
		if (beans instanceof Collection) {
			filterName = AnnotationUtils.getValue(
					AnnotationUtils.findAnnotation(CollectionUtils.get(beans, 0).getClass(), JsonFilter.class))
					.toString();
		} else {
			filterName = AnnotationUtils.getValue(AnnotationUtils.findAnnotation(beans.getClass(), JsonFilter.class))
					.toString();
		}
		return toJsonIgnoreProperties(beans, filterName, properties);
	}

	public static String toJsonIgnoreProperties(Object beans, String filterName, String[] properties)
	...
	public static String toJsonIncludeProperties(Object beans, String filterName, String[] properties)
			throws RuntimeException {
		if (beans == null) {
			return "";
		}
	 ...
	 */
	public static JavaType getCollectionType(ObjectMapper objectMapper, Class<?> collectionCls, Class<?>... beanCls)
			throws RuntimeException {
