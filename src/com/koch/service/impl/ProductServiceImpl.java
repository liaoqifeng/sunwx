...
import com.koch.entity.Product.OrderType;
...
public class ProductServiceImpl extends BaseServiceImpl<Product> implements ProductService{
	...
	public List<Product> findList(ProductCategory productCategory, Brand brand,
			...
			Boolean isTop, Boolean isGift, Boolean isPrize, Boolean isOutOfStock,
			Boolean isStockAlert, Product.OrderType orderType, Integer count,
			List<Filter> filters, List<OrderBy> orders){
		return productDao.findList(productCategory, brand, promotion, tags, propertyValue, startPrice, endPrice, isPublish, isShow, isTop, isGift, isPrize, isOutOfStock, isStockAlert, orderType, count, filters, orders);
	}
	
	public List<Product> findList(Boolean isPublish,Boolean isShow,Boolean isTop,Boolean isGift,Boolean isPrize,Integer count){
		return productDao.findList(null, null, null, null, null, null, null, isPublish, isShow, isTop, isGift, isPrize, null, null, OrderType.coinDesc, count, null, null);
	}
	...
	public Pager findByPager(ProductCategory productCategory,Brand brand,Boolean isPublish,Boolean isGift,Boolean isPrize,String name,String number,Pager pager){
		return productDao.findByPager(productCategory, brand, isPublish, isGift,isPrize, name, number, pager);
	}
