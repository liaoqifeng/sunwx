...
public class Product extends BaseEntity{
	...
	public enum OrderType{
		topDesc, priceAsc, priceDesc, salesDesc, scoreDesc, dateDesc, coinDesc;
	}
	
	private String number;  //商品编号
	private String name;  //商品名称
	private String fullName;  //商品全称
	private Integer classifyId;  //商品分类    暂时无用
	private ProductCategory productCategory;   //商品类别
	private Brand brand;  //商品品牌
	private Integer stock;   //商品总库存
	private Integer lockStock;   //商品锁定库存
	private String unit;   //商品单位
	private BigDecimal salePrice;   //销售价
	private BigDecimal costPrice;   //成本价
	private BigDecimal marketPrice;   //市场价
	private BigDecimal coinPrice;  //金币兑换数
	private Boolean isPublish;   //是否发布
	private String describtion;  //seo描述
	private String keywords;   //seo关键字
	private String title;  //seo标题
	private String searchKey;  //查询key
	private Integer score;  //赠送积分
	private Boolean isVipPrice;  //是否启用会员价
	private String vipPrice;  //暂时无用
	private Boolean isGift;  //是否赠品
	private Boolean isTop;  //是否置顶
	private Boolean isShow; //是否显示
	private Boolean isPrize;  //是否礼品
	private BigDecimal weight;   //重量
	private String cargoSpace;  //仓位
	private String remark;   //备注
	private String showImg;  //展示图片
	private Goods goods;  //货品
	private String introduction;    //简介
	private Integer salesCount;  //销售数量 
	private Integer weekSalesCount;  //周销售量
	private Integer monthSalesCount;  //月销售量
	private Date weekSalesDate;  //最后一周销售时间
	private Date monthSalesDate;  //最后一月销售时间
