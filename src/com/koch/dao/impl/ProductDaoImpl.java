...
public class ProductDaoImpl extends BaseDaoImpl<Product> implements ProductDao {
	...
	public List<Product> findList(ProductCategory productCategory, Brand brand,
		...
		if (isPrize != null) {
			predicate = criteriaBuilder.and(predicate, criteriaBuilder.equal(root.get("isPrize"), isPrize));
		}
		...
		if (orderType == Product.OrderType.priceAsc) {
			...
			orders.add(new OrderBy("createDate", OrderType.desc));
		}else if (orderType == Product.OrderType.coinDesc) {
			orders.add(new OrderBy("coinPrice", OrderType.asc));
		} else {
