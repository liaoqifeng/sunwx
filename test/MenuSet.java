...
public class MenuSet {
	...
	private static void createMenu() throws Exception {
		...
		String s31 = getUrlMenu("挖金币", PropertiesUtil.getProperty(PropertiesUtil.BASE_URL)+"/sunwx/weixin/member/coin/index.shtml", true);
		String s32 = getUrlMenu("金币超市", PropertiesUtil.getProperty(PropertiesUtil.BASE_URL)+"/sunwx/weixin/member/coin/gift.shtml", true);
		String s33 = getUrlMenu("超级任务", PropertiesUtil.getProperty(PropertiesUtil.BASE_URL)+"/sunwx/weixin/member/task/index.shtml", true);
		String s34 = getUrlMenu("水果机", PropertiesUtil.getProperty(PropertiesUtil.BASE_URL)+"/sunwx/weixin/member/game/slot.shtml", true);
		...
		String s5 = getUrlMenu("天地认证", PropertiesUtil.getProperty(PropertiesUtil.BASE_URL)+"/sunwx/weixin/mui/list.html", true);
