		    	...
		    	<table class="table-edit" width="100%" align="center" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="text" id="showImgBtn" name="image" value="${article.image }" class="text" maxlength="255"/>&nbsp;
		      			...
		      			<tr>
		      				...
		      				<td align="left">
		      					<input type="text" name="showText" value="${article.showText }" class="text long" maxlength="255" style="width:600px;"/>&nbsp;
		      				</td>
		      			</tr>
		      			<tr>
		      				<td align="right">跳转链接：&nbsp;&nbsp;</td>
		      				<td align="left">
		      					<input type="text" name="url" value="${article.url }" class="text long" maxlength="255"/>&nbsp;
		      				</td>
		      			</tr>
		      			<tr>
