...
<head>
	...
	<script type="text/javascript">
		function doEdit(id){
			window.location.href='${path}/back/prize/edit/'+id+'.shtml';
		}
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/prize/list/pager.shtml',
				toolbar:$toolBox,
				pagination:true,
				rownumbers: true,
				width:'auto',
			...
			$("a[button='delete']").click(function(){
				...
				if(rows != null && rows != ""){
					$.post("${path}/back/prize/delete.shtml",$(":checkbox[name='id']").serialize(),function(data){
						$.message(data);
						reload();
					});
				}
...
<body>
	...
	<div id="toolBox">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="50">
					<a href="${path }/back/prize/view.shtml" class="easyui-linkbutton" iconCls="icon-add" plain="true">${fn:call("Common.button.add")}</a>
					...
					<a href="#" style="display: none;" button="searchMore" class="easyui-linkbutton" iconCls="icon-search" plain="true">${fn:call("Common.button.more")}</a>
				</td>
				<td align="right">
