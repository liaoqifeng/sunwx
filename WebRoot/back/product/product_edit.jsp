				...
				<table id="infoTab" width="100%" class="input tabContent">
					...
					<tr>
						...
						<td>
							...
							<input type="checkbox" name="isGift" value="true" ${product.isGift?"checked='checked'":"" }/>是否为赠品
							<input type="checkbox" name="isPrize" value="true" ${product.isPrize?"checked='checked'":"" }/>是否为礼品
						</td>
