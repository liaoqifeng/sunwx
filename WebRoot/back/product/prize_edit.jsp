...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-edit" title="&nbsp;&nbsp;修  改  礼  品  ">
			<form id="editForm" action="${path }/back/prize/edit.shtml" method="post" enctype="multipart/form-data">
		    	<input id="id" type="hidden" name="id" value="${product.id }"/>
		    	<ul id="tab" class="tab">
					<li><input value="基本信息" type="button" /></li>
					<li style="display: none;"><input value="商品参数" type="button" /></li>
					<li style="display: none;"><input value="商品属性" type="button" /></li>
					<li style="display: none;"><input value="商品规格" type="button" /></li>
				...
				<table id="infoTab" width="100%" class="input tabContent">
					...
					<tr>
						...
						<td>
							<input type="text" name="coinPrice" value="<fmt:formatNumber value="${product.coinPrice }" pattern="##0"/>" class="text short"  maxlength="100"/>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="score" value="${product.score }" class="text short" maxlength="10"/>
						</td>
					...
					<tr>
						...
						<td>
							...
							<span class="hidden"><input type="checkbox" name="isGift" value="true" ${product.isGift?"checked='checked'":"" }/>是否为抽奖赠品</span>
