			...
			$editForm.validate({
				rules: {
					"number":{
						pattern: /^[0-9a-zA-Z_-]+$/,
						remote: {
							url: "${path}/back/prize/view/check.shtml?oldNumber=${product.number }",
							cache: false
						}
					},
					"name": {
...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-edit" title="&nbsp;&nbsp;新  增   礼  品 ">
			<form id="editForm" action="${path }/back/prize/add.shtml" method="post" enctype="multipart/form-data">
		    	<ul id="tab" class="tab">
					<li><input value="基本信息" type="button" /></li>
					<li style="display: none;"><input value="礼品参数" type="button" /></li>
					<li style="display: none;"><input value="礼品属性" type="button" /></li>
					<li style="display: none;"><input value="礼品规格" type="button" /></li>
					<li><input value="礼品图片" type="button" /></li>
					<li><input value="礼品简介" type="button" /></li>
				</ul>
				<table id="infoTab" width="100%" class="input tabContent">
					...
					<tr class="hidden">
						<td height="30" align="right">礼品分类： </td>
						<td>
						...
						<td height="30" align="right">品牌： </td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="marketPrice" class="text short" value="0" maxlength="10"/>
						</td>
					</tr>
					<tr>
						...
						<td height="30" align="right">&nbsp;金币购买价： </td>
						<td>
							<input type="text" name="coinPrice" class="text short" value="0" maxlength="100"/>
						</td>
					</tr>
					<tr>
						<td height="30" align="right"><font color="red">*</font>&nbsp;库存： </td>
						<td>
					...
					<tr class="hidden">
						<td height="30" align="right"><font color="red">*</font>&nbsp;兑换积分： </td>
						<td>
							<input type="text" name="score" value="0" class="text short" maxlength="10"/>
						</td>
					...
					<tr>
						...
						<td>
							...
							<span class="hidden"><input type="checkbox" name="isGift" value="true" />是否为抽奖赠品</span>
							<span class="hidden"><input type="checkbox" name="isPrize" value="true" checked='checked' />是否为礼品</span>
						</td>
						<td height="30" align="right">礼品上架：</td>
						<td>
				...
				<table id="parameterTab" width="100%" class="input tabContent" style="display: none;"></table>
				<table id="propertyTab" width="100%" class="input tabContent" style="display: none;"></table>
				<table id="specTab" class="input tabContent table-spec" style="display: none;">
