		...
		<script type="text/javascript">
			$().ready(function(){
				...
				$captchaImage.click(function(){
					$captchaImage.attr("src", "${path }/back/common/captcha.jsp?captchaId=${captchaId}&timestamp=" + (new Date()).valueOf());
				});
			});
		</script>
	</head>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<img id="captchaImage" class="captchaImage" title="刷新验证码" src="${path }/back/common/captcha.jsp?captchaId=${captchaId}"/>
						</td>
					</tr>
					<tr>
						<th>&nbsp;</th>
					...
					<tr>
						...
						<td>
							<button id="loginButton" class="loginButton" type="submit">
								...
								<div id="loadWord" class="word hidden">正在登录</div>
