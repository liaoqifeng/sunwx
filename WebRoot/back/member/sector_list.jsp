...
<head>
	...
	<script type="text/javascript">
		function doEdit(id){
			window.location.href='${path}/back/sector/edit/'+id+'.shtml';
		}
		$().ready(function(){
			...
			$mainTable.datagrid({
				url:'${path }/back/sector/list/pager.shtml',
				idField:'id',
				toolbar:$toolBox,
				pagination:true,
				width:'auto',
			...
			$("a[button='delete']").click(function(){
				...
				if(rows != null && rows != ""){
					$.post("${path}/back/sector/delete.shtml",$(":checkbox[name='id']").serialize(),function(data){
						$.message(data);
...
<body>
	...
	<div id="toolBox">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="50">
					<a href="${path }/back/sector/view.shtml" class="easyui-linkbutton" iconCls="icon-add" plain="true">新    增</a>
