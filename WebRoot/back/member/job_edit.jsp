...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-add" title="&nbsp;&nbsp;修  改  职  位">
			<form id="editForm" action="${path }/back/job/edit.shtml" method="post">
				<input type="hidden" name="id" value="${job.id }"/>
				<input type="hidden" name="createDate" value="${job.createDate }"/>
		    	<table class="table-edit" align="center" cellpadding="0" cellspacing="0">
		      		<tbody>
		      			<tr>
		      				<td width="30%" align="right"><font color="red">*&nbsp;&nbsp;</font>名称：&nbsp;&nbsp;</td>
		      				<td width="70%" align="left"><input type="text" name="name" value="${job.name }" class="text"/></td>
		      			</tr>
		      			<tr>
		      				<td align="right">排序：&nbsp;&nbsp;</td>
		      				<td align="left"><input type="text" name="index" value="${job.index }" class="text short"/></td>
		      			</tr>
		      			<tr>
		      				<td height="60"></td>
		      				<td align="left">
