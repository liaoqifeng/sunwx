...
<body>
	<div id="mainBox" class="main-box">
		<div id="mainPanel" class="easyui-panel" iconCls="icon-edit" title="&nbsp;&nbsp;新  增  会  员">
			<form id="editForm" action="${path }/back/member/add.shtml" method="post">
				...
				<table width="100%" class="input tabContent table">
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input type="text" name="deposit" value="${member.deposit }" class="text middle" maxlength="20"/></td>
		    		</tr>
		    		<tr>
		    			<td height="30" align="right"><font color="red">*</font>&nbsp;积分：&nbsp;&nbsp;</td>
		    			<td align="left"><input type="text" name="score" value="${member.score }" class="text middle" maxlength="20"/></td>
		    		</tr>
		    		<tr>
