...
<body style="background: #B81F24;">
	<div id="bg" style="width:100%;position:relative;">
		<img src="${path}/weixin/common/images/guaguale_bg.png" style="width:100%;"/>
		<div id="gua1" style="width:295px;margin:0 auto;position:absolute;z-index:100;left:10px;right:10px;top:52%;" >
			<img id="gua1_img" src="${path}/weixin/common/images/gua_image.png" style="width:300px;height:140px;position: absolute;">
			<div style="width: 284px;height: 124px;left:8px;top:8px;background: #cacaca;position: absolute;">
				<div id="gua_body" style="width: 100%;height: 100%;display:inline-block; position:relative;"></div>
			</div>
		</div>
		<div id="notify" style="width:300px;height:101px;margin:0px auto 0px auto;background: url(${path}/weixin/common/images/notice_bg.png);background-size: 300px 101px;">
