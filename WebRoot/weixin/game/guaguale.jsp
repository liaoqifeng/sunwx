...
<head>
	...
	<style type="text/css">
	.wx-solt-tip{ margin:200px 10px 10px 10px;min-height: 100px;padding:10px 10px 10px 10px;font-size:13px; word-wrap:break-word;background-color: #ffedaf; border-radius: 5px;clear: both;}
	</style>
</head>
<body style="background: #B81F24;">
	<div id="bg" style="background: url(${path}/weixin/common/images/guaguaka_bg.png);background-size: 100% 100%;">
		...
		<div id="notify" class="wx-solt-tip"><h4 style="font-size: 15px;margin:0;padding:0;">规则说明：</h4>${game.description }</div>
		<!-- <div id="notify" style="width:300px;height:101px;margin:200px auto 0px auto;background: url(${path}/weixin/common/images/notice_bg.png);background-size: 300px 101px;">
			<div id="nImg_div" style="position: absolute;color:white;font-size: 17px;font-family: '黑体'" align="center">
				<div style="width:245px;height:101px;padding:10px 0px 0px 50px;" align="left">${game.description }</div>
			</div> -->
		</div>
	</div>
...
<script type="text/javascript">
	...
	$gua_body.wScratchPad({
      ...
      fg: '#9C9C9C',
      size : 40,
      scratchDown : function(){document.addEventListener('touchmove', pd , false);}, 
      scratchUp   : function(){document.removeEventListener('touchmove', pd, false);}, 
