;(function($, window, undefined) {
    ...
    Dialog.prototype = {
        ...
        ok : function() {
            ...
            }).text(this.settings.okText).addClass('rDialog-ok').prependTo(footer);
        ...
        cancel : function() {
            ...
            }).text(this.settings.cancelText).addClass('rDialog-cancel').appendTo(footer);
        ...
        position : function() {
            ...
            this.dialog.css({ 
                ...
                top : (winHeight - _this.dialog.height()) / 2 + scrollTop - 50
            });
